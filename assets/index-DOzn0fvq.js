var R=Object.defineProperty;var A=(e,n,r)=>n in e?R(e,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[n]=r;var C=(e,n,r)=>A(e,typeof n!="symbol"?n+"":n,r);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))u(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&u(d)}).observe(document,{childList:!0,subtree:!0});function r(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function u(o){if(o.ep)return;o.ep=!0;const a=r(o);fetch(o.href,a)}})();async function Y(e){const n=document.getElementById("gpu-status");if(!navigator.gpu)throw console.error("WebGPU not supported on this browser."),n&&(n.innerText="WebGPU not supported!"),new Error("WebGPU not supported.");const r=await navigator.gpu.requestAdapter();if(!r)throw console.error("No appropriate GPUAdapter found."),n&&(n.innerText="No compatible GPU found!"),new Error("No appropriate GPUAdapter found.");const u=await r.requestDevice();if(!u)throw console.error("Failed to get WebGPU device."),n&&(n.innerText="Failed to initialize WebGPU!"),new Error("Failed to get WebGPU device.");console.log("WebGPU initialized successfully!"),n&&(n.innerText="WebGPU is working!");const o=e.getContext("webgpu"),a=navigator.gpu.getPreferredCanvasFormat();return o.configure({device:u,format:a}),{device:u,context:o,format:a}}const W=`@vertex
...
`,H=`// Subtract Pressure Compute Shader
...
`,K=`// This shader advects the velocity field itself using a semi-Lagrangian method.
...
`,J=`@group(0) @binding(0) var<storage, read> velocity: array<vec2<f32>>;
...
`,Z=`@group(0) @binding(0) var<storage, read> pressureBuf: array<f32>;
...
`;function $(e,n){const r=e.createShaderModule({code:W});return e.createRenderPipeline({vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:[{format:n}]},primitive:{topology:"triangle-strip"},layout:"auto"})}function ee(e){const n=e.createShaderModule({code:L});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function ne(e){const n=e.createShaderModule({code:k});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function re(e){const n=e.createShaderModule({code:I});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function te(e){const n=e.createShaderModule({code:N});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function ie(e){const n=e.createShaderModule({code:q});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function oe(e){const n=e.createShaderModule({code:X});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function ue(e){const n=e.createShaderModule({code:j});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function ae(e){const n=e.createShaderModule({code:H});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function de(e){const n=e.createShaderModule({code:K});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function se(e){const n=e.createShaderModule({code:J});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function ce(e){const n=e.createShaderModule({code:Q});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function le(e){const n=e.createShaderModule({code:Z});return e.createComputePipeline({compute:{module:n,entryPoint:"main"},layout:"auto"})}function fe(e,n){const r=$(e,n),u=ee(e),o=ne(e),a=re(e),d=te(e),l=ie(e),f=oe(e),s=ue(e),c=ae(e),m=de(e),g=se(e),p=ce(e),y=le(e);return{renderPipeline:r,velPipeline:u,advectionPipeline:o,decayPipeline:a,velDecayPipeline:d,injectionPipeline:l,divPipeline:f,pressurePipeline:s,subPressurePipeline:c,advectVelPipeline:m,vorticityPipeline:g,addVorticityPipeline:p,clearPressurePipeline:y}}class pe{constructor(n,r,u){C(this,"pos",[0,0]);C(this,"vel",[0,0]);C(this,"isMouseDown",!1);let o=[0,0];n.addEventListener("mousedown",a=>{this.isMouseDown=!0;const d=n.getBoundingClientRect();o=[(a.clientX-d.left)/d.width,(a.clientY-d.top)/d.height]}),n.addEventListener("mouseup",()=>{this.isMouseDown=!1,this.vel=[0,0],this.updateGPUBuffer(r,u)}),n.addEventListener("mousemove",a=>{if(!this.isMouseDown)return;const d=n.getBoundingClientRect(),l=[(a.clientX-d.left)/d.width,(a.clientY-d.top)/d.height];this.vel=[l[0]-o[0],l[1]-o[1]],this.pos=l,o=l,this.updateGPUBuffer(r,u)})}updateGPUBuffer(n,r){const u=new Float32Array([this.pos[0],this.pos[1],this.vel[0],this.vel[1]]);n.queue.writeBuffer(r,0,u)}}function ge(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST})}function ye(e,n){return e.createBuffer({size:n*n*2*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function me(e,n){return e.createBuffer({size:n*n*2*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function xe(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function ve(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function he(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Be(e,n){return e.createBuffer({size:n*n*3*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function Pe(e,n){return e.createBuffer({size:n*n*3*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function be(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Ge(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Se(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Ee(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function _e(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Ce(e,n){return e.createBuffer({size:n*n*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function ze(e,n){return e.createBuffer({size:n*n*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function Ue(e,n){return e.createBuffer({size:n*n*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function we(e,n){return e.createBuffer({size:n*n*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function Te(e,n){return e.createBuffer({size:n*n*2*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}function De(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Oe(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Fe(e){return e.createBuffer({size:4*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}function Me(e,n,r){const u=ge(e),o=ye(e,n),a=me(e,n),d=xe(e),l=ve(e),f=he(e),s=Be(e,n),c=Pe(e,n),m=be(e),g=Ee(e),p=Ge(e),y=Se(e),B=_e(e),z=Ce(e,n),U=ze(e,n),w=Ue(e,n),T=we(e,n),D=Te(e,n),P=De(e),b=Oe(e),G=Fe(e),O=new Float32Array([10.5,.5,.5,0]);e.queue.writeBuffer(g,0,O);const S=1/n,E=1/S,v=new Float32Array([n,n,S,E]),h=new Float32Array([10,0,0,0]),F=new Float32Array([.5,0,0,0]);e.queue.writeBuffer(d,0,v),e.queue.writeBuffer(l,0,h),e.queue.writeBuffer(f,0,F);const i=new Float32Array([.99,0,0,0]);e.queue.writeBuffer(p,0,i);const t=new Float32Array([.99,0,0,0]);e.queue.writeBuffer(y,0,t);const _=new Float32Array([r.width,r.height]);e.queue.writeBuffer(B,0,_);const x=new Float32Array([5,0,0,0]);e.queue.writeBuffer(P,0,x);const M=new Float32Array([.8,0,0,0]);e.queue.writeBuffer(b,0,M);const V=new Float32Array([.99,0,0,0]);return e.queue.writeBuffer(G,0,V),{mouseBuf:u,velBuf:o,velOutBuf:a,gridSizeBuf:d,radiusBuf:l,strengthBuf:f,dyeFieldBuf:s,dyeFieldOutBuf:c,deltaTimeBuf:m,injectionAmtBuf:g,decayBuf:p,velDecayBuf:y,canvasSizeBuf:B,divBuf:z,pressureBuf:U,pressureOutBuf:w,vorticityBuf:T,vorticityForceBuf:D,vorticityStrengthBuf:P,viscosityBuf:b,diffusionBuf:G}}function Ve(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.velBuf}},{binding:1,resource:{buffer:r.mouseBuf}},{binding:2,resource:{buffer:r.gridSizeBuf}},{binding:3,resource:{buffer:r.radiusBuf}},{binding:4,resource:{buffer:r.strengthBuf}},{binding:5,resource:{buffer:r.deltaTimeBuf}},{binding:6,resource:{buffer:r.velOutBuf}},{binding:7,resource:{buffer:r.diffusionBuf}}]})}function Re(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.velBuf}},{binding:1,resource:{buffer:r.dyeFieldBuf}},{binding:2,resource:{buffer:r.dyeFieldOutBuf}},{binding:3,resource:{buffer:r.gridSizeBuf}},{binding:4,resource:{buffer:r.deltaTimeBuf}}]})}function Ae(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.dyeFieldBuf}},{binding:1,resource:{buffer:r.mouseBuf}},{binding:2,resource:{buffer:r.injectionAmtBuf}},{binding:3,resource:{buffer:r.gridSizeBuf}},{binding:4,resource:{buffer:r.deltaTimeBuf}},{binding:5,resource:{buffer:r.diffusionBuf}},{binding:6,resource:{buffer:r.dyeFieldOutBuf}}]})}function Ye(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.gridSizeBuf}},{binding:1,resource:{buffer:r.dyeFieldBuf}},{binding:2,resource:{buffer:r.decayBuf}}]})}function We(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.gridSizeBuf}},{binding:1,resource:{buffer:r.velBuf}},{binding:2,resource:{buffer:r.velDecayBuf}}]})}function Le(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.velBuf}},{binding:1,resource:{buffer:r.divBuf}},{binding:2,resource:{buffer:r.gridSizeBuf}}]})}function ke(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.divBuf}},{binding:1,resource:{buffer:r.pressureBuf}},{binding:2,resource:{buffer:r.gridSizeBuf}},{binding:3,resource:{buffer:r.pressureOutBuf}}]})}function Ie(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.velBuf}},{binding:1,resource:{buffer:r.pressureBuf}},{binding:2,resource:{buffer:r.gridSizeBuf}}]})}function Ne(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.velBuf}},{binding:1,resource:{buffer:r.velOutBuf}},{binding:2,resource:{buffer:r.gridSizeBuf}},{binding:3,resource:{buffer:r.deltaTimeBuf}}]})}function qe(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.velBuf}},{binding:1,resource:{buffer:r.gridSizeBuf}},{binding:2,resource:{buffer:r.vorticityBuf}}]})}function Xe(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.velBuf}},{binding:1,resource:{buffer:r.vorticityBuf}},{binding:2,resource:{buffer:r.gridSizeBuf}},{binding:3,resource:{buffer:r.vorticityStrengthBuf}},{binding:4,resource:{buffer:r.deltaTimeBuf}},{binding:5,resource:{buffer:r.velOutBuf}}]})}function je(e,n,r){return e.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.pressureBuf}},{binding:1,resource:{buffer:r.pressureOutBuf}},{binding:2,resource:{buffer:r.gridSizeBuf}},{binding:3,resource:{buffer:r.viscosityBuf}}]})}function He(e,n,r){const u=Ve(e,n.velPipeline,r),o=Re(e,n.advectionPipeline,r),a=Ae(e,n.injectionPipeline,r),d=Ye(e,n.decayPipeline,r),l=We(e,n.velDecayPipeline,r),f=Le(e,n.divPipeline,r),s=ke(e,n.pressurePipeline,r),c=Ie(e,n.subPressurePipeline,r),m=Ne(e,n.advectVelPipeline,r),g=qe(e,n.vorticityPipeline,r),p=Xe(e,n.addVorticityPipeline,r),y=je(e,n.clearPressurePipeline,r);return{velBindGroup:u,advectionBindGroup:o,injectionBindGroup:a,decayBindGroup:d,velDecayBindGroup:l,divBindGroup:f,pressureBindGroup:s,subPressureBindGroup:c,advectVelBindGroup:m,vorticityBindGroup:g,addVorticityBindGroup:p,clearPressureBindGroup:y}}function Ke(e,n,r,u){const o=e.createCommandEncoder(),a=n.getCurrentTexture().createView(),d=o.beginRenderPass({colorAttachments:[{view:a,loadOp:"clear",storeOp:"store",clearValue:[0,0,0,1]}]});d.setPipeline(r),d.setBindGroup(0,u),d.draw(4),d.end(),e.queue.submit([o.finish()])}function Je({device:e,context:n,buffers:r,bindGroups:u,pipelines:o,mouseHandler:a,gridSize:d}){async function l(){y(e,r),a.isMouseDown&&(m(),E()),g(),v(),G(),v(),w(),T();for(let i=0;i<20;i++)D(),h();P(),h(),b(),h(),O(),S(),v(),B(),E(),z(),U(),Ke(e,n,o.renderPipeline,F()),requestAnimationFrame(l)}const f=8,s=Math.ceil(d/f),c=Math.ceil(d/f);function m(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.injectionPipeline),t.setBindGroup(0,u.injectionBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function g(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.velPipeline),t.setBindGroup(0,u.velBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}let p=performance.now();function y(i,t){const _=performance.now();let x=(_-p)/1e3;p=_,x>1/60&&(x=1/60),x*=2;const M=new Float32Array([x]);i.queue.writeBuffer(t.deltaTimeBuf,0,M)}function B(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.advectionPipeline),t.setBindGroup(0,u.advectionBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function z(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.decayPipeline),t.setBindGroup(0,u.decayBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function U(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.velDecayPipeline),t.setBindGroup(0,u.velDecayBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function w(){const i=new Float32Array(d*d).fill(0);e.queue.writeBuffer(r.divBuf,0,i)}function T(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.divPipeline),t.setBindGroup(0,u.divBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function D(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.pressurePipeline),t.setBindGroup(0,u.pressureBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function P(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.subPressurePipeline),t.setBindGroup(0,u.subPressureBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function b(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.clearPressurePipeline),t.setBindGroup(0,u.clearPressureBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function G(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.advectVelPipeline),t.setBindGroup(0,u.advectVelBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function O(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.vorticityPipeline),t.setBindGroup(0,u.vorticityBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function S(){const i=e.createCommandEncoder(),t=i.beginComputePass();t.setPipeline(o.addVorticityPipeline),t.setBindGroup(0,u.addVorticityBindGroup),t.dispatchWorkgroups(s,c),t.end(),e.queue.submit([i.finish()])}function E(){const i=e.createCommandEncoder();i.copyBufferToBuffer(r.dyeFieldOutBuf,0,r.dyeFieldBuf,0,r.dyeFieldBuf.size),e.queue.submit([i.finish()])}function v(){const i=e.createCommandEncoder();i.copyBufferToBuffer(r.velOutBuf,0,r.velBuf,0,r.velBuf.size),e.queue.submit([i.finish()])}function h(){const i=e.createCommandEncoder();i.copyBufferToBuffer(r.pressureOutBuf,0,r.pressureBuf,0,r.pressureBuf.size),e.queue.submit([i.finish()])}function F(){return e.createBindGroup({layout:o.renderPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r.gridSizeBuf}},{binding:1,resource:{buffer:r.canvasSizeBuf}},{binding:2,resource:{buffer:r.dyeFieldBuf}}]})}l()}async function Qe(){const e=document.createElement("canvas");e.width=window.innerWidth,e.height=window.innerHeight,document.body.appendChild(e);const{device:n,context:r,format:u}=await Y(e),o=512,a=Me(n,o,e),d=fe(n,u),l=He(n,d,a),f=new pe(e,n,a.mouseBuf);Je({device:n,context:r,buffers:a,bindGroups:l,pipelines:d,mouseHandler:f,gridSize:o})}Qe();
