var A=Object.defineProperty;var Y=(e,n,r)=>n in e?A(e,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[n]=r;var C=(e,n,r)=>Y(e,typeof n!="symbol"?n+"":n,r);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))u(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&u(d)}).observe(document,{childList:!0,subtree:!0});function r(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function u(o){if(o.ep)return;o.ep=!0;const a=r(o);fetch(o.href,a)}})();async function W(e){const n=document.getElementById("gpu-status");if(!navigator.gpu)throw console.error("WebGPU not supported on this browser."),n&&(n.innerText="WebGPU not supported!"),new Error("WebGPU not supported.");const r=await navigator.gpu.requestAdapter();if(!r)throw console.error("No appropriate GPUAdapter found."),n&&(n.innerText="No compatible GPU found!"),new Error("No appropriate GPUAdapter found.");const u=await r.requestDevice();if(!u)throw console.error("Failed to get WebGPU device."),n&&(n.innerText="Failed to initialize WebGPU!"),new Error("Failed to get WebGPU device.");console.log("WebGPU initialized successfully!"),n&&(n.innerText="WebGPU is working!");const o=e.getContext("webgpu"),a=navigator.gpu.getPreferredCanvasFormat();return o.configure({device:u,format:a}),{device:u,context:o,format:a}}const I=`@vertex
